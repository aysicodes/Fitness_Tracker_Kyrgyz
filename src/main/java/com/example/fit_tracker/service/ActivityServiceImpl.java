...
//        activity.setUser(currentUser); // ПРИВЯЗКА К ПОЛЬЗОВАТЕЛЮ
//
...
//            throw new IllegalArgumentException("You are not authorized to update this activity.");
//        }
//
//        activity.setDate(dto.getDate());
//        activity.setSteps(dto.getSteps());
...
//        // Проверка владения
//        if (!activity.getUser().getId().equals(currentUser.getId())) {
//            throw new IllegalArgumentException("You are not authorized to delete this activity.");
//        }
//
